...
public class HP_PopapLight : MonoBehaviour
{
    ...
    private void On9()
    {
        ...
        {
            _manager.gameManager.SendMessageToServer.OnAll();
            _is9 = true;
        }
    }
    ...
    private void On9A()
    {
        ...
        {
            _is9A = false;
            _manager.gameManager.UdpClient.AddMessage("0180011400000000", "Off On9A"); //1
        }
        else
        {
            _manager.gameManager.UdpClient.AddMessage("0180010A00000000", "On On9A"); //1
            _is9A = true;
        }
    }
    ...
    private void On10()
    {
        ...
        {
            _is10 = false;
            _manager.gameManager.UdpClient.AddMessage("0180041400000000", "Off On10"); //4!
        }
        else
        {
            _is10 = true;
            _manager.gameManager.UdpClient.AddMessage("0180040A00000000", "On On10"); //4!
        }
    }
    ...
    private void OnSchool()
    {
        if (_isSchool)
        {
            _manager.gameManager.UdpClient.AddMessage("0180021400000000", "Off School"); //2
            _isSchool = false;
        }
        else
        {
            _manager.gameManager.UdpClient.AddMessage("0180020A00000000", "On School"); //2
            _isSchool = true;
        }
    }
    ...
    private void OnOffice1()
    {
        if (_isOffice1)
        {
            _manager.gameManager.UdpClient.AddMessage("0180031400000000", "Off Office"); //Общая подсветка 5
            _isOffice1 = false;
        }
        else
        {
            _manager.gameManager.UdpClient.AddMessage("0180030A00000000", "On Office"); //Общая подсветка 5
            _isOffice1 = true;
        }
    }
